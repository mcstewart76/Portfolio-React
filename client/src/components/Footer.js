...
import { CDBModalFooter, CDBBtn, CDBIframe, CDBBox } from 'cdbreact';
  ...
  return (
    <CDBModalFooter className="shadow">
      ...
      >
        ...
        <CDBBox>
          <small className="ml-2">&copy; Chris Stewart, 2022. All rights reserved.</small>
        </CDBBox>
        <CDBBox display="flex">
          <CDBBtn flat color="dark" className="p-2">
            <CDBIframe fab icon="facebook-f" />
          </CDBBtn>
          <CDBBtn flat color="dark" className="mx-3 p-2">
            <CDBIframe fab icon="twitter" />
          </CDBBtn>
          <CDBBtn flat color="dark" className="p-2">
            <CDBIframe fab icon="instagram" />
          </CDBBtn>
        </CDBBox>
      </CDBBox>
    </CDBModalFooter>
